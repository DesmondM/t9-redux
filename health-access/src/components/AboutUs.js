            ...
            <div className="row d-flex align-items-center">
                ...
                <div className="col-lg-6">
                    <div className="info-2-img wow fadeInUp" data-wow-delay="0.6s">
                        <img className="img-fluid" src="images/image-04.png" alt="info-image"/>
                    </div>
                </div>
                ...
                <div className="row d-flex align-items-center">
                    ...
                    <div className="col-lg-6 offset-lg-1">
                        <div className="banner-txt pc-30 wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <a href="https://dev.zd-solutions.co.za/ords/plexi/r/agent-portal/login_desktop/" target="_blank" className="btn btn-tra-white blue-hover">Join Now</a>
